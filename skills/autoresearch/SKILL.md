...
async function load() {
  try {
    ...
    render(EMBEDDED); // fallback for file:// URLs
  }
}
```
...
1. Create a dedicated research root folder: `research/autoresearch/`
2. Create the skill-specific working directory: `research/autoresearch/[skill-name]/`
